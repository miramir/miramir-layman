...
# chunkin-nginx-module (https://github.com/agentzh/chunkin-nginx-modulei, BSD license)
HTTP_CHUNKIN_MODULE_PV="0.23rc2"
HTTP_CHUNKIN_MODULE_SHA1="ddc0dd5"
HTTP_CHUNKIN_MODULE_P="chunkin-nginx-module-${HTTP_CHUNKIN_MODULE_PV}"
HTTP_CHUNKIN_MODULE_URI="https://github.com/agentzh/chunkin-nginx-module/tarball/v${HTTP_CHUNKIN_MODULE_PV}"
HTTP_CHUNKIN_MODULE_WD="${WORKDIR}/agentzh-chunkin-nginx-module-${HTTP_HEADERS_MORE_MODULE_SHA1}"
...
SRC_URI="http://nginx.org/download/${P}.tar.gz
	...
	nginx_modules_http_chunk? ( ${HTTP_CHUNKIN_MODULE_URI} -> ${HTTP_CHUNKIN_MODULE_P}.tar.gz )"
...
src_configure() {
	...
	if use nginx_modules_http_chunk; then
		http_enabled=1
